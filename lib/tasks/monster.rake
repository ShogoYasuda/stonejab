  ...
  task :insert do
    ...
    for i in 1..1401
      ...
      doc.css("#monster").each do |row|
        ...
        column.arousal10 = row.css('div:nth-child(10) > div:nth-child(10) > p.skill-name > a').text unless row.css('div:nth-child(10) > div:nth-child(10) > p.skill-name > a').count == 0
        column.save
